...
#+AUTHOR: Chuck
#+DESCRIPTION: Use rassumfrassum to connect a LSP client to multiple LSP servers.
#+KEYWORDS: Emacs, Eglot, LSP
#+DATE: <2025-12-18 Thu 09:36>
...
[[https://github.com/joaotavora/rassumfrassum][rassumfrassum]], developed by the author of Eglot, can work with Eglot to connect to multiple servers. Hopefully, Eglot may have built-in multiple LSP servers support.
