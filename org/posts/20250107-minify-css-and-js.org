...
发布博客时，压缩[[https://developer.mozilla.org/zh-CN/docs/Web/CSS][CSS]]和[[https://developer.mozilla.org/zh-CN/docs/Web/JavaScript][JavaScript]]文件的大小，能提升网页的加载速度，这里介绍使用[[https://github.com/cssnano/cssnano][cssnano]]和[[https://github.com/mishoo/UglifyJS][UglifyJS]]工具来压缩。
