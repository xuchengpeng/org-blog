...
PS: Do not set ~GTK_IM_MODULE~ & ~QT_IM_MODULE~ & ~SDL_IM_MODULE~. You could unset ~GTK_IM_MODULE~ & ~QT_IM_MODULE~ by runing ~im-config~ and then selecting "do not set any IM from im-config and use desktop default".
