...
#+DESCRIPTION: A guide to build emacs from source on Linux.
...
Build [[https://launchpad.net/libvterm][libvterm]] if you need to use [[https://github.com/akermu/emacs-libvterm][vterm]] on Linux.
